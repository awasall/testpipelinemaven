...
import devweb.sa.projetfilrouge.config.JwtTokenUtil;
import devweb.sa.projetfilrouge.model.JwtRequest;
import devweb.sa.projetfilrouge.model.JwtResponse;
...
public class JwtAuthenticationController {
    ...
    @RequestMapping(value = "/api/login_check", method = RequestMethod.POST, consumes = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_FORM_URLENCODED_VALUE })
